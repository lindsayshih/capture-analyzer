...
public class MAC implements Serializable
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1587890881043688697L;
	 ...
	 * @return the mac+1.
	 */
	public static MAC incMAC(MAC theMac)
	{
	 ...
	 * @return the mac - 1.
	 */
	public static MAC decMAC(MAC theMAC)
	{
		long val = theMAC.getAsLong();
		return new MAC(++val);
	}
	...
	{
		if (theObj == null || !(theObj instanceof MAC))
				return false;
		return getAsLong() == (((MAC)theObj).getAsLong());
	}
		
	public static void main (String args[])
	{
		MAC m = new MAC("00:de:ad:be:ef:00");
