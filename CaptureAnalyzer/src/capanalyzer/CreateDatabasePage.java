...
public class CreateDatabasePage extends WizardPage
{
	...
	public void createControl(Composite parent)
	{
		...
		Text schemaText = new Text(container, SWT.BORDER);
		createControlDecoration(schemaText);
		...
		bind(dbc, usernameText, database, "username", new NotEmptyValidator("username"));
		bind(dbc, passwordText, database, "password", new NotEmptyValidator("password"));
		bind(dbc, schemaText, database, "schema", null);
		...
		aggregateValidationStatus.addValueChangeListener(new IValueChangeListener() {
			...
			{
				// the invocation of the getValue method is necessary the further changes will be fired
	...
	private void bind(DataBindingContext dbc, Text textWidget, Object bean, String property, IValidator validator)
	{
