...
public class ByteUtils
{
	...
	public static byte[] getAs_uint32_NetOrder(int theNumber)
	{
		...
		toReturn[0] = (byte) (theNumber & 0xf000);
		toReturn[1] = (byte) (theNumber & 0x0f00);
		toReturn[2] = (byte) (theNumber & 0x00f0);
		toReturn[3] = (byte) (theNumber & 0x000f);
	 ...
	 * Read as Big Indian (Network) Byte Order.
	 ...
	 * @return the num 
	 */
	public static long getByteNetOrderTo_uint32(byte[] theBytes,int idx)
	{
		long sum = 0;
		for (int i=0 ; i<4 ; i++)
		{
	...
	/**
	 * pull out a byte (unsigned) to int.
	 * Read as Little Endian (Pentium native) Byte Order.
	 * @param theBytes - the byte array.
	 * @param idx - the byte location.
	 * @return the int value (0-255)
	 */
	public static int getBytePenOrderTo_uint8(byte[] theBytes,int idx)
	{
		return theBytes[idx] & 0xff;
	}
	 ...
	 * @return the num (0-65535)
	 */
	public static int getBytePenOrderTo_uint16(byte[] theBytes,int idx)
	{
		int sum = 0;
		for (int i=1 ; i>=0 ; i--)
		{
	 ...
	 * @return the num 
	 */
	public static long getBytePenOrderTo_uint32(byte[] theBytes,int idx)
	{
		long sum = 0;
		for (int i=3 ; i>=0 ; i--)
		{
	 ...
	 * @return signed long value.
	 */
	public static long getBytePenOrder(byte[] theBytes,int idx,int size)
	{
		long sum = 0;
