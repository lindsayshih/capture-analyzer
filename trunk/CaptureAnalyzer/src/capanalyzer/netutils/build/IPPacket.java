...
public class IPPacket extends EthernetPacket
{
	...
	private static final int DEFAULT_FARGMENT = 0;
	 ...
	 */
	public IPPacket(byte[] thePacket)
	{
		super(thePacket);
	 ...
	 * @param theLengh
	 */
	protected void setTotaIPlLength(int theLengh)
	{
	...
	public long getSourceIP()
	{
		...
		{
		     mySrcIp = ByteUtils.getByteNetOrderTo_uint32(myPacket, myIPHdrOffset + IP_SRC_POS);
		     _isReadSrcIp = true;
		}
		return mySrcIp;
	}
	...
	public long getDestinationIP()
	{
		...
		{
			_isReadDstIp = true;
		     myDstIp = ByteUtils.getByteNetOrderTo_uint32(myPacket, myIPHdrOffset + IP_DST_POS);
		}
		return myDstIp;
	}
	...
	{
		return ByteUtils.getByteNetOrderTo_uint8(thePacket, EthernetPacket.ETHERNET_HEADER_LENGTH + IP_Proto_POS);
	}
	...
	public static IPPacket getPacket(byte[] thePacket)
	{
		try
		{
			...
			case IPPacketType.TCP:
				return new TCPPacket(thePacket);
