...
public class PCapPacketHeader
{
	...
	public PCapPacketHeader readNextPcktHeader(InputStream in, boolean flip) throws IOException
	{
		...
		timeValSec32Uint = ByteUtils.getByteNetOrderTo_uint32(tmp, 0);
		timeValMsec32Uint = ByteUtils.getByteNetOrderTo_uint32(tmp, 4);
		caplen32Uint = ByteUtils.getByteNetOrderTo_uint32(tmp, 8);
		pktlenUint32 = ByteUtils.getByteNetOrderTo_uint32(tmp, 12);
